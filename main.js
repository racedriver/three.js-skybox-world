...
class BasicWorldDemo {
    ...
    _Initialize() {
        ...
        this._camera.position.set(-900, -200, 900);
      ...
      let controls = new OrbitControls(this._camera, this._threejs.domElement);
      controls.addEventListener('change', this._threejs);
      ...
      controls.maxDistance = 1500;
        ...
        loader1.load('fonts/helvetiker_regular.typeface.json', (font) => {
          ...
          var material = new THREE.MeshBasicMaterial( { color: 0x30C47E } );
